...
public class ExternalController {
    ...
    public Object addJoinGroupRequest(@RequestBody PojoAddJoinGroupRequest pojoAddJoinGroupRequest) {
        return inService.addJoinGroupRequest(pojoAddJoinGroupRequest.domainId, pojoAddJoinGroupRequest.operator, pojoAddJoinGroupRequest.group_id, pojoAddJoinGroupRequest.userIds, pojoAddJoinGroupRequest.reason, pojoAddJoinGroupRequest.extra);
    }
